...
def seed_news_data(db: Session):
    ...
    articles = [
        ...
        make_news(cat_sanxuat,
            ...
            "<p>TBS Group hiện vận hành <strong>33 dây chuyền sản xuất</strong> với <strong>25.000 công nhân</strong>, đạt công suất <strong>21 triệu đôi giày/năm</strong> và <strong>10 triệu túi xách/năm</strong>.</p><p>Các nhà máy trọng điểm trải dài khắp cả nước: <strong>TBS Thoại Sơn, TBS Kiên Giang, TBS Sông Trà, TBS Đồng Xoài, TBS Miền Trung</strong>.</p><p>Sản phẩm được xuất khẩu sang hơn 50 quốc gia, phục vụ các thương hiệu hàng đầu như Decathlon, Skechers, Reebok, Coach, Tory Burch, Lancaster.</p>",
            "san-xuat,giay-dep,tui-xach,21-trieu", True, 30,
            "https://www.tbsgroup.vn/linh-vuc-hoat-dong/linh-vuc-giay-da/"),

        make_news(cat_sanxuat,
            "Nhà máy TBS Thoại Sơn (An Giang): 8 năm kiến tạo & phát triển bền vững",
            "Từ năm 2017, TBS Thoại Sơn đã phát triển thành cụm nhà máy hiện đại với 5.000 nhân sự, công suất 10 triệu đôi giày/năm, là đối tác chiến lược của Decathlon.",
            "<p>Tọa lạc tại Ấp Thanh Niên, TT. Phú Hòa, Thoại Sơn, An Giang, <strong>TBS Thoại Sơn</strong> là một trong những nhà máy sản xuất giày trọng điểm của TBS Group.</p><p><strong>Các con số ấn tượng:</strong></p><ul><li>8 năm phát triển (2017-2025)</li><li>2 nhà máy hiện đại</li><li>5.000 nhân sự</li><li>Công suất 10 triệu đôi giày/năm</li></ul><p>Năm 2018, đôi giày Decathlon đầu tiên ra đời tại đây, đánh dấu bước ngoặt quan trọng. Hiện nhà máy đang trong giai đoạn chuyển đổi số theo hướng công nghiệp 4.0.</p>",
            "thoai-son,an-giang,decathlon,8-nam", True, 60,
        ...
        make_news(cat_benvung,
            "TBS Thoại Sơn trao 1.488 suất học bổng cho con em người lao động năm 2024",
            "Công ty Cổ phần TBS An Giang đã trao 1.488 suất học bổng cho con em đoàn viên, người lao động có thành tích học tập xuất sắc.",
            "<p>Năm 2024, <strong>Công ty Cổ phần TBS An Giang</strong> (TBS Thoại Sơn) đã tổ chức trao <strong>1.488 suất học bổng</strong> cho con em đoàn viên và người lao động đạt thành tích học tập xuất sắc trong năm học.</p><p>Đây là minh chứng cho cam kết của TBS Group đối với <strong>trách nhiệm xã hội</strong> và sự phát triển bền vững của cộng đồng địa phương nơi nhà máy hoạt động.</p>",
            "hoc-bong,thoai-son,an-giang,1-488-suat", False, 500,
        ...
        make_news(cat_congnghe,
            "TBS Thoại Sơn trên hành trình chuyển đổi số - Xây dựng nhà máy thông minh",
            "Giai đoạn 2024-2025, TBS Thoại Sơn tập trung chuyển đổi số toàn diện: từ quản lý sản xuất, bảo trì dự đoán, đến báo cáo thời gian thực.",
            "<p>TBS Thoại Sơn đang trong giai đoạn <strong>chuyển đổi số mạnh mẽ</strong> theo hướng công nghiệp 4.0, với các hệ thống nội bộ được nâng cấp toàn diện:</p><ul><li><strong>Quản lý Nhân sự:</strong> Phân tích hiệu suất theo thời gian thực</li><li><strong>Kế hoạch Sản xuất:</strong> Tối ưu hóa và dự báo bằng AI</li><li><strong>Bảo trì Thông minh:</strong> Theo dõi máy móc, phân tích dự đoán sự cố</li><li><strong>Quản lý Chất lượng:</strong> Kiểm soát chất lượng toàn diện</li><li><strong>Báo cáo Trực quan:</strong> Dashboard thời gian thực</li></ul>",
            "chuyen-doi-so,nha-may-thong-minh,thoai-son,4.0", True, 150,
            "https://tbs-thoaisonshoes.com/"),

  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-[#08221a]">Quản Lý Phòng Ban Doanh Nghiệp</h1>
          ...
          <tbody className="divide-y divide-gray-100 text-xs text-gray-700">
            {departments.map((d) => (
              <tr key={d.id} className="hover:bg-gray-50/80 transition">
                <td className="p-4 font-mono font-bold text-[#158a63]">{d.code}</td>
                <td className="p-4 font-semibold text-[#08221a]">{d.name}</td>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl p-6 max-w-md w-full shadow-2xl space-y-4">
            <h2 className="text-lg font-bold text-[#08221a]">Thêm Phòng Ban Mới</h2>
